      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 32px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ color: 'var(--text2)', fontSize: 13, margin: '4px 0 0 0' }}>
            All doctors registered under your hospital
          </p>
        </div>
              ...
              <thead>
                <tr style={{ background: 'var(--bg3)', borderBottom: '2px solid var(--border)' }}>
                  {['Doctor', 'Specialization', 'Phone', 'Email', 'Joined'].map((h) => (
                    <th key={h} style={{ textAlign: 'left', padding: '13px 16px', fontSize: 11, fontWeight: 700, color: 'var(--text3)', textTransform: 'uppercase', letterSpacing: 0.6 }}>
                      {h}
                    </th>
                  ))}
                </tr>
                  ...
                  >
                    <td style={{ padding: '13px 16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
                        <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'var(--accent)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 800, flexShrink: 0 }}>
