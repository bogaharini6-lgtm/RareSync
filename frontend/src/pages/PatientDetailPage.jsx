...
export default function PatientDetailPage() {
  ...
  const handleRequestAccess = async (e) => {
    ...
    try {
      ...
      setRequestSuccess(
        'Access request submitted. Waiting for hospital approval.'
      );
  ...
  const handleUnlink = async (linkId, diseaseName) => {
    if (
      !window.confirm(
        `Remove "${diseaseName}" from this patient?`
      )
    ) {
      return;
    }
      ...
      <div style={styles.container}>
        ...
        {accessLevel === 'limited' &&
          user?.role === 'doctor' && (
            <div style={styles.limitedBanner}>
              ...
              <div style={styles.limitedIcon}>
                🔒
              </div>

              <div style={{ flex: 1 }}>
                <p style={styles.limitedTitle}>
                  Limited access
                </p>

                <p style={styles.limitedDesc}>
                  You can only see basic patient
                  information. Request access from
                  the hospital to view full details
                  including medical records, diagnoses,
                  and prescriptions.
                </p>
              </div>
        ...
        {accessLevel === 'limited' && (
          <div style={styles.card}>
            ...
            <DetailRow
              label="Access"
              value="Request access to see full details"
            />
          </div>
        )}
